...
const About = ({ lang }) => {
  ...
  const stats = [
    ...
    { label: 'Active Students', value: '5000+', icon: <Users size={24} /> },
    { label: 'Success Rate', value: '98%', icon: <Star size={24} /> },
    { label: 'Video Lessons', value: '200+', icon: <BookOpen size={24} /> },
  ];
  ...
  return (
    <div className="pt-24 pb-20 min-h-screen overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 mb-24">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 dark:text-white">
              Hi, I'm <span className="gradient-text">Miss Rania</span>
            </h1>
            <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              I am a dedicated English educator in Tunisia with over a decade of experience in helping students unlock their potential through the beauty of the English language.
            </p>
            <div className="space-y-6">
              <div className="flex items-start space-x-4 rtl:space-x-reverse">
                ...
                <div>
                  <h3 className="font-bold dark:text-white">Professional Journey</h3>
                  <p className="text-slate-600 dark:text-slate-400">Former teacher in high-profile schools and now focused on building the best digital education platform in Tunisia.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4 rtl:space-x-reverse">
                ...
                <div>
                  <h3 className="font-bold dark:text-white">Teaching Philosophy</h3>
                  <p className="text-slate-600 dark:text-slate-400">Education should be fun, interactive, and tailored to the modern student. I believe in learning by doing.</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 py-16 px-8 rounded-3xl bg-slate-900 text-white relative overflow-hidden">
